    ...
    <div className="container mx-auto px-4 py-6 flex flex-col lg:flex-row gap-6">
      ...
      <div className="w-full lg:w-1/3 space-y-4">
        ...
        <div className="flex flex-col gap-3">
          ...
          <button className="flex items-center justify-center font-semibold gap-2 px-4 py-2
           rounded-full bg-gradient-to-r from-indigo-500 to-purple-500 text-white cursor-not-allowed">
            <HiOutlineBellSnooze />
            Snooze 2 weeks
          </button>

          <button className="flex items-center justify-center gap-2 px-4 py-2
           rounded-full bg-green-100 text-green-700 border cursor-not-allowed font-semibold">
            <RiInboxArchiveLine />
            Archive
          </button>

          <button className="flex items-center justify-center gap-2 px-4 py-2
          rounded-full bg-red-100 text-red-600 border cursor-not-allowed font-semibold">
            <RiDeleteBin6Line />
            Delete
          </button>
        </div>
